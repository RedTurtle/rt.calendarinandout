...
def setup_product():
    ...
    import rt.calendarinandout
    zcml.load_config('configure.zcml', rt.calendarinandout)
    ...
    ztc.installPackage('rt.calendarinandout')
...
setup_product()
ptc.setupPloneSite(products=['rt.calendarinandout'])
